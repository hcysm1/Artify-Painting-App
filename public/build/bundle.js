...
var app = (function () {
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, stroke, $$value => $$invalidate(15, $stroke = $$value));
    	validate_store(selectedShape, 'selectedShape');
    	component_subscribe($$self, selectedShape, $$value => $$invalidate(16, $selectedShape = $$value));
    	validate_store(shape, 'shape');
    	component_subscribe($$self, shape, $$value => $$invalidate(17, $shape = $$value));
    	validate_store(selectedStroke, 'selectedStroke');
    	component_subscribe($$self, selectedStroke, $$value => $$invalidate(18, $selectedStroke = $$value));
    	...
    	const setCanvasBackground = () => {
    		...
    		$$invalidate(8, context.fillStyle = "beige", context);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option0, file$1, 13, 2, 291);
    			option1.__value = "triangle";
    			option1.value = option1.__value;
    			add_location(option1, file$1, 14, 2, 339);
    			option2.__value = "circle";
    			option2.value = option2.__value;
    			add_location(option2, file$1, 15, 2, 385);
    			option3.__value = "hexagon";
    			option3.value = option3.__value;
    			add_location(option3, file$1, 16, 2, 427);
    			option4.__value = "ellipse";
    			option4.value = option4.__value;
    			add_location(option4, file$1, 17, 2, 471);
    			attr_dev(select0, "class", "dropdown svelte-10vqb9b");
    			if (/*$selectedShape*/ ctx[0] === void 0) add_render_callback(() => /*select0_change_handler*/ ctx[4].call(select0));
    			add_location(select0, file$1, 6, 0, 118);
    			add_location(h21, file$1, 19, 0, 524);
    			option5.__value = "pen";
    		...
    		m: function mount(target, anchor) {
    			...
    			select_option(select0, /*$selectedShape*/ ctx[0], true);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(select0, "change", /*change_handler*/ ctx[5], false, false, false, false),
    					listen_dev(select1, "change", /*select1_change_handler*/ ctx[6]),
    					listen_dev(select1, "change", /*change_handler_1*/ ctx[7], false, false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$selectedShape*/ 1) {
    				select_option(select0, /*$selectedShape*/ ctx[0]);
    			}

    			if (dirty & /*$selectedStroke*/ 8) {
    				select_option(select1, /*$selectedStroke*/ ctx[3]);
    			}
    		},
    		i: noop,
    		o: noop,
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let $selectedStroke;
    	validate_store(selectedShape, 'selectedShape');
    	component_subscribe($$self, selectedShape, $$value => $$invalidate(0, $selectedShape = $$value));
    	validate_store(shape, 'shape');
    	component_subscribe($$self, shape, $$value => $$invalidate(1, $shape = $$value));
    	validate_store(stroke, 'stroke');
    	component_subscribe($$self, stroke, $$value => $$invalidate(2, $stroke = $$value));
    	validate_store(selectedStroke, 'selectedStroke');
    	component_subscribe($$self, selectedStroke, $$value => $$invalidate(3, $selectedStroke = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	const change_handler = e => (set_store_value(selectedShape, $selectedShape = e.target.value, $selectedShape), set_store_value(shape, $shape = "true", $shape), set_store_value(stroke, $stroke = "false", $stroke));
    	...
    	const change_handler_1 = e => (set_store_value(selectedStroke, $selectedStroke = e.target.value, $selectedStroke), set_store_value(shape, $shape = "false", $shape), set_store_value(stroke, $stroke = "true", $stroke));
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section0, "class", "canvas svelte-12jvczr");
    			add_location(section0, file, 15, 4, 447);
    			attr_dev(h20, "class", "svelte-12jvczr");
    			add_location(h20, file, 22, 8, 679);
    			attr_dev(button0, "class", "clear-canvas svelte-12jvczr");
    			add_location(button0, file, 23, 8, 703);
    			attr_dev(button1, "class", "save-img svelte-12jvczr");
    			add_location(button1, file, 24, 8, 778);
    			attr_dev(div0, "class", "canvas-tools svelte-12jvczr");
    			add_location(div0, file, 21, 6, 644);
    			attr_dev(div1, "class", "painting-tools svelte-12jvczr");
    			add_location(div1, file, 27, 6, 859);
    			attr_dev(h21, "class", "svelte-12jvczr");
    			add_location(h21, file, 32, 8, 961);
    			attr_dev(input, "class", "size-slider svelte-12jvczr");
    			attr_dev(input, "type", "range");
    			attr_dev(input, "min", "0");
    			attr_dev(input, "max", "100");
    			add_location(input, file, 36, 8, 1093);
    			attr_dev(div2, "class", "styles-tools svelte-12jvczr");
    			add_location(div2, file, 31, 6, 926);
    			attr_dev(h22, "class", "svelte-12jvczr");
    			add_location(h22, file, 46, 8, 1294);
    			attr_dev(div3, "class", "background-tools svelte-12jvczr");
    			add_location(div3, file, 45, 6, 1255);
    			attr_dev(section1, "class", "toolbox svelte-12jvczr");
    			add_location(section1, file, 20, 4, 612);
    			attr_dev(div4, "class", "container");
    			add_location(div4, file, 13, 2, 389);
    			attr_dev(body, "class", "svelte-12jvczr");
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(tools, div1, null);
    			append_dev(section1, t7);
    			append_dev(section1, div2);
    			append_dev(div2, h21);
    			append_dev(div2, t9);
    			mount_component(colorinput, div2, null);
    			append_dev(div2, t10);
    			append_dev(div2, input);
