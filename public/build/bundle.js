...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option0, file$1, 13, 2, 286);
    			option1.__value = "triangle";
    			option1.value = option1.__value;
    			add_location(option1, file$1, 14, 2, 334);
    			option2.__value = "circle";
    			option2.value = option2.__value;
    			add_location(option2, file$1, 15, 2, 380);
    			option3.__value = "hexagon";
    			option3.value = option3.__value;
    			add_location(option3, file$1, 16, 2, 422);
    			option4.__value = "ellipse";
    			option4.value = option4.__value;
    			add_location(option4, file$1, 17, 2, 466);
    			...
    			add_location(h21, file$1, 19, 0, 519);
    			option5.__value = "pen";
    			option5.value = option5.__value;
    			add_location(option5, file$1, 27, 2, 707);
    			option6.__value = "dashedLine";
    			option6.value = option6.__value;
    			add_location(option6, file$1, 28, 2, 743);
    			option7.__value = "line";
    			option7.value = option7.__value;
    			add_location(option7, file$1, 29, 2, 794);
    			option8.__value = "gradientLine";
    			option8.value = option8.__value;
    			add_location(option8, file$1, 30, 2, 842);
    			...
    			add_location(select1, file$1, 20, 0, 537);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(select0, "click", /*click_handler*/ ctx[5], false, false, false, false),
    					listen_dev(select1, "change", /*select1_change_handler*/ ctx[6]),
    					listen_dev(select1, "click", /*click_handler_1*/ ctx[7], false, false, false, false)
    				];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const click_handler = e => (set_store_value(selectedShape, $selectedShape = e.target.value, $selectedShape), set_store_value(shape, $shape = true, $shape), set_store_value(stroke, $stroke = false, $stroke));
    	...
    	const click_handler_1 = e => (set_store_value(selectedStroke, $selectedStroke = e.target.value, $selectedStroke), set_store_value(shape, $shape = false, $shape), set_store_value(stroke, $stroke = true, $stroke));
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h20 = element("h2");
    			h20.textContent = "Artify";
    			t2 = space();
    			div0 = element("div");
    			button0 = element("button");
    			span0 = element("span");
    			span0.textContent = "download";
    			t4 = space();
    			...
    			span2 = element("span");
    			span2.textContent = "zoom_in";
    			t8 = space();
    			button3 = element("button");
    			span3 = element("span");
    			span3.textContent = "zoom_out";
    			t10 = space();
    			div1 = element("div");
    			...
    			span6 = element("span");
    			span6.textContent = "undo";
    			t16 = space();
    			button7 = element("button");
    			span7 = element("span");
    			span7.textContent = "redo";
    			t18 = space();
    			div2 = element("div");
